...
const BTC_FLIP_ADDRESS = "0x3f45170C16aC36eC05470Ac7f9E8c7239e8BC013";
const OSM_ADDRESS = "0x38c1f10BB772B9944d709d0fA4b5539b66BbF1aC";
...
const flipContract = new web3.eth.Contract(FLIPPER_ABI, BTC_FLIP_ADDRESS);
    ...
    for (let i = 0; i < events.length; i++) {
        ...
        if (event.event === "Kick") {
            ...
            if (osmPrice > 0) {
                ...
                values += "Рыночная цена: ₽" + auctions[flipId]["bidPrice"] + " | ";
                values += "Цена сделки: ₽" + auctions[flipId]["paidPrice"] + " | ";
            } else {
                values += "--,-- % | Рыночная цена: ₽---,-- | Цена сделки: ₽---,-- |";
            }
